use dioxus::prelude::*;
use dioxus_free_icons::icons::ld_icons::{LdGithub, LdKeyRound, LdMail, LdUser, LdX};
use dioxus_free_icons::Icon;

#[component]
pub fn RegisterModal() -> Element {
  rsx! {
    dialog { class: "modal", id: "register_modal",
      div { class: "modal-box relative max-w-xs md:max-w-sm",
        ...
        div { class: "text-center text-xl font-medium", "Create an Account" }
