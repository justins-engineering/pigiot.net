    ...
    section { id: "features", class: "py-20 relative",
      ...
      div { class: "container mx-auto px-4 sm:px-6 relative",
        ...
        div { class: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8",
          div { class: "flex flex-col justify-around space-y-6 bg-stone-800/30 border border-stone-700 rounded-2xl p-8 card-hover",
            div { class: "w-16 h-16 rounded-2xl bg-linear-to-br from-teal-900 to-teal-800 flex items-center justify-center feature-icon shadow-lg",
              Icon {
                icon: LdCodeXml,
          ...
          div {
            class: "flex flex-col justify-around space-y-6 bg-stone-800/30 border border-stone-700 rounded-2xl p-8 card-hover",
            style: "animation-delay: 0.2s;",
            div { class: "w-16 h-16 rounded-2xl bg-linear-to-br from-purple-900 to-purple-800 flex items-center justify-center feature-icon shadow-lg",
              Icon {
                icon: LdLockKeyhole,
          ...
          div {
            ...
            div { class: "w-16 h-16 rounded-2xl bg-linear-to-br from-teal-900 to-purple-900 flex items-center justify-center feature-icon shadow-lg",
              Icon {
